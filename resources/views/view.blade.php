    ...
    <section style="display: flex; justify-content: center; align-items: center; margin-top:60px  ">
            <form action="{{ route('entrada')}}">
                <div class="form-floating mb-3">
                    <input type="text" class="form-control" placeholder="Nombre Grupo" name="nombre_grupo" style="width: 300px;">
                    <label>Nombre del evento</label>
                </div> 
                <button style="width: 300px;"> Consultar </button >
            </form>
    </section>
            
    <section class="parte1" style="display: flex; justify-content: center; align-items: center; flex-direction: column; margin-top: 100px;">
            <img src="{{ asset('images/team.png') }}" alt="people" style="height: 200px">

            <p style="font-size: 200px"> {{$numero_entradas}}</p>
    </section>
